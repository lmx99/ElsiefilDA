...
public class MainActivity extends BaseActivity implements EMEventListener {
  ...
  //  private LogisticsFragment logisticsFragment;
    ...
    private void initView() {
        ...
        mTabs[3] = (Button) findViewById(R.id.btn_logistics);
        mTabs[4] = (Button) findViewById(R.id.btn_find);
        // 把第一个tab设为选中状态
    ...
    public void setXG() {
        ...
        XGPushManager.registerPush(getApplicationContext(),Preferences.getUserName(),
    ...
    private static class HandlerExtension extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg != null) {
                System.out.println(XGPushConfig.getToken(theActivity));
            }
    ...
    public void setJsonDb(JSONObject user_obj) {
        try {
            ...
            com.boshu.db.UserDao ud=new com.boshu.db.UserDao(this);
            ...
            /*//如果用户
            if(sex.equals("3")&&age.equals("0")&&nickanme.equals("")&&head_image.equals("")
                    &&beforeIdCard.equals("")&&afterIdCard.equals("")&&idCard.equals("")&&resume.equals("")&&job_want.equals("")
                    &&qq.equals("")&&email.equals("")&&friendPhone.equals("")&&myPhone.equals("")&&real_name.equals("")
