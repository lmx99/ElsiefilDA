package com.lifeisle.jekton.db;
...
//    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        Logger.e(TAG, "upgrade from version " + oldVersion + " to version " + newVersion
                + ", which will destroy all old data");
        db.execSQL("drop table if it exist " + TABLE_ORDERS);
        db.execSQL("drop table if it exist " + TABLE_GOODS);
        db.execSQL("drop table if it exist " + TABLE_LOGISTICS);

        db.execSQL("drop index if it exist " + INDEX_ORDERS);
        db.execSQL("drop index if it exist " + INDEX_GOODS);
